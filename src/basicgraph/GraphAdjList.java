...
public class GraphAdjList extends Graph {
	...
	public void implementAddVertex() {
		//System.out.println("Called inside the graphAdjList implementAddVertex...");
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 // implemented
		 List <Integer> oneHopVertices = new ArrayList <Integer>();
		 List <Integer> twoHopVertices = new ArrayList <Integer>();
		 oneHopVertices.addAll(getNeighbors(v));
		 Iterator<Integer> setIterator=  oneHopVertices.iterator();
		 while (setIterator.hasNext()){
			 twoHopVertices.addAll(getNeighbors(setIterator.next()));
		 }
		 List <Integer> finalTwoHopVertices = new ArrayList<Integer>();
		 finalTwoHopVertices.addAll(twoHopVertices);
		 //System.out.println("FinalTwoHopVertices = "+finalTwoHopVertices);
		 Collections.sort(finalTwoHopVertices);
		 Collections.reverse(finalTwoHopVertices);
		 //System.out.println("FinalTwoHopVertices = "+finalTwoHopVertices);
		 return finalTwoHopVertices;
	}
